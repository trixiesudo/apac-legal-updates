...
from .database import get_stats, init_db, list_legal_ai_updates, list_published_newsletters, list_updates, upsert_newsletter
...
from .models import DigestSourceSummaryRequest, DigestSourceSummaryResult, DraftEmailRequest, DraftEmailResult, LegalAiSourceOut, LegalAiUpdateOut, NewsletterOut, PublishNewsletterRequest, RefreshResult, SourceOut, UpdateOut
...
def risk_heatmap() -> dict:
    ...
    for country in COUNTRIES:
        for update in list_updates(country=country, limit=200):
